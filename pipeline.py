"""
Production Machine Learning Pipeline for Diabetes Risk Classification & Health Analytics.
...
def train_and_evaluate(csv_path: str = "diabetes_risk_dataset_text_labels.csv"):
...
def main():
    parser = argparse.ArgumentParser(description="Diabetes Risk Classification & Health Analytics CLI")
    parser.add_argument("--data", type=str, default="diabetes_risk_dataset_text_labels.csv", help="Path to CSV dataset")
